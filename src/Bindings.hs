...
-- |The 'keyboard' function is called whenever the user presses a key.
...
-- |The 'idle' function is called by the main loop every frame.
...
-- |The 'mouse' function is called every time the mouse does something.
